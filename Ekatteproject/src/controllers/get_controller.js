...
routes.get("GET").set("/swagger-ui.css", async (req, res) => {
  const filePath = path.join(swaggerUiPath, "swagger-ui.css");
  // console.log("Filepath", filePath);
  const data = await fs.readFile(filePath, "utf-8");
  // console.log("Data", data);
...
routes.get("GET").set("/index.css", async (req, res) => {
  const filePath = path.join(swaggerUiPath, "index.css");
  // console.log("Filepath", filePath);
  const data = await fs.readFile(filePath, "utf-8");
  // console.log("Data", data);
  res.writeHead(200, { "Content-Type": "text/css" });
...
routes.get("GET").set("/swagger-initializer.js", async (req, res) => {
...
routes.get("GET").set("/swagger-ui-bundle.js", async (req, res) => {
  const filePath = path.join(swaggerUiPath, "swagger-ui-bundle.js");
  // console.log("Filepath", filePath);
  const data = await fs.readFile(filePath, "utf-8");
  // console.log("Data", data);
  res.writeHead(200, { "Content-Type": "application/js" });
...
routes
  .get("GET")
  .set("/swagger-ui-standalone-preset.js", async (req, res) => {
